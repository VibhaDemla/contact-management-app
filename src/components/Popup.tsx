...
/**
 * Interface for a Contact object, which contains the following properties:
 * - id: string
 * - first_name: string
 * - last_name: string
 * - mob: string
...
/**
 * Interface for PopupProps, which contains the following properties:
 * - close: a function to close the popup
 * - el: a Contact object
 */
...
/**
 * The Popup component, which displays the contact details in a popup.
 */  
